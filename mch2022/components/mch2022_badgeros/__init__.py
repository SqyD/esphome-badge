...
Mch2022_BadgerosComponent = mch2022_rp2040_ns.class_("Mch2022_BadgerosComponent", cg.Component)

CONFIG_SCHEMA = (
    cv.Schema({cv.Required(CONF_ID): cv.declare_id(Mch2022_BadgerosComponent)})
